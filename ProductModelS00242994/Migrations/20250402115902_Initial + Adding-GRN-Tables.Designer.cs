...
namespace ProductModel.Migrations
{
    ...
    [Migration("20250402115902_Initial + Adding-GRN-Tables")]
    partial class InitialAddingGRNTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductModel.GRN.GRN", b =>
                {
            ...
            modelBuilder.Entity("ProductModel.GRN.GRNLine", b =>
                {
            ...
            modelBuilder.Entity("ProductModel.GRN.GRNLine", b =>
                {
                    b.HasOne("ProductModel.GRN.GRN", "parentGRN")
                        .WithMany("GRNLines")
                        .HasForeignKey("GrnID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProductModel.Product", "associatedProduct")
                        .WithMany()
